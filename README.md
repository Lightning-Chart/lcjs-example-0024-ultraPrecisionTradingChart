# lcjs-example-0024-ultraPrecisionTradingChart
...
```
cd existing_repo
git remote add origin https://gitlab.com/arction/lcjs/lcjs-examples/lcjs-example-0024-ultraprecisiontradingchart.git
git branch -M master
